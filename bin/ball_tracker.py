...
ap.add_argument("-b", "--buffer", type=int, default=0,  #lunghezza della coda, std=64
...
#Upper = (64, 255, 255)
#Yellow
#colorLower = (8, 120, 105)
#colorUpper = (68, 180, 225)
#Blue
colorLower = (80, 147, 91)
colorUpper = (140, 207, 211)
